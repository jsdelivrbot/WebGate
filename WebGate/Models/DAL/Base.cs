...
namespace WebGate.Models.DAL
{
    ...
    /// </summary>
    public class DalHelperFuncInserter<TEntity, TSource> : DalHelperBase<TEntity, TSource>, IDalInserter<TEntity> where TSource : class
    {
        public void Add(TEntity item) => AddFunc(Source, item);
        public Action<TSource, TEntity> AddFunc { get; set; }

        public DalHelperFuncInserter(TSource source, Action<TSource, TEntity> addFunc) : base(source)
        {
            AddFunc = addFunc;
        }
        public override void Dispose()
    ...
    public class DalHelperDbSetInserter<TEntity> : DalHelperBase<TEntity, DbSet<TEntity>>, IDalInserter<TEntity> where TEntity : class
    {
        ...
        public void Add(TEntity item) => Source.Add(item);
    }
    ...
    public class DalProvAccessBuilder<TEntity, TSource> : IDalProvAccessBuilder<TEntity, TSource> where TEntity : class where TSource : class
    {
        ...
        public IDalProvAccessBuilder<TEntity, TSource> SetInsertAccess(Action<TSource, TEntity> funcAdd)
        {
            _dalAccessor.InserterFunc = (src => new DalHelperFuncInserter<TEntity, TSource>(src, funcAdd));
            return this;
        }
        #endregion
    ...
    public class ControllerHelper 
    {
        ...
        public static IEnumerable<KeyValuePair<string, object>> ToKeyValuePair<TEntity>(HttpRequest source) where TEntity : class
        {
            ...
            //var t1 = t.GetMembers();
            //var t2 = t.GetProperties();
            //var n = typeof(TEntity).GetProperties();
